...
::: r-fit-text
**R Script**: create code based text file that allows you to save and
execute code at your discretion

> *File \> New File \> R Script*

<br />

**R Markdown** or **Quarto Document**: allows you to combine narrative
text, code, and the output of code in a single document.
...
the folder that you are working in, where you store your files, and
where you load your files.
...
::: notes
ready-made tools or functions that you can use in the R programming
language. Imagine you have a toolbox, and in that toolbox, you have
different tools for various tasks like measuring, cutting, or fixing
things.
:::
...
::: notes
arguments in R as the ingredients or details you provide to a function,
like telling a chef how to prepare your food. These arguments help
customize what the function does, and the function's output is like the
dish you receive based on your requests.
:::

## Documentation

provides the necessary information, explanations, examples, and guidance
to help you learn, understand, and effectively use R functions and
packages.
...
-   The **TAB** button will also provide help with suggestions and
...
::: notes
"object" is a fundamental concept that can be thought of as a container
or a holder for data. Just like in everyday life, you use different
containers like bags, boxes, or drawers to store and organize your
things
:::
...
R packages are like toolkits or collections of pre-built functions, data
sets, and tools that extend the capabilities of the R programming
language.
...
For every new session, you must load the package to use the it's
functions.
...
two-dimensional sequence of data variables (columns) and observations
(rows). While each variable in a data frame typically contains data of
the same type, different variable can contain different data types.
...
used to select and work with specific variables (columns) from a data
frame.
...
function from tidyverse. There is also the **read.csv( )** function in
base R.
...
-   [Jeff Werst](https://directory.lib.wvu.edu/employee/259)
-   [Data Cleaning and Analysis with R and
    RStudio](https://wvu.libcal.com/event/11343694)
-   [Data Visualization and Presentation with R and
    RStudio](https://wvu.libcal.com/event/11343718)
